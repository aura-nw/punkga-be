CREATE TABLE "public"."ip_asset" ("id" serial NOT NULL, "user_id" bpchar NOT NULL, "nft_token_id" text NOT NULL, "nft_contract_address" text NOT NULL, "ip_asset_id" text NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") , FOREIGN KEY ("user_id") REFERENCES "public"."authorizer_users"("id") ON UPDATE cascade ON DELETE cascade, UNIQUE ("ip_asset_id"));
