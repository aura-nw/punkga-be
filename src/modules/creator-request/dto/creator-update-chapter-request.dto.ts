...
import { ChapterLanguage } from '../../chapter/dto/create-chapter-request.dto';
...
export class CreatorUpdateChapterRequestDto {
  @ApiProperty()
  @IsNumber()
  requestor_id: number;
...
export class CreatorUpdateChapterParamDto {
  @ApiProperty()
  @IsNumber()
  chapterId: number;
}
